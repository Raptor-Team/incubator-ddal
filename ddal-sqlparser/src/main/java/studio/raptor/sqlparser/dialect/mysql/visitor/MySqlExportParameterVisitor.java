...
public class MySqlExportParameterVisitor extends MySqlOutputVisitor implements
  ...
  public MySqlExportParameterVisitor(List<Object> parameters, Appendable appender,
      boolean wantParameterizedOutput) {
    super(appender, true);
