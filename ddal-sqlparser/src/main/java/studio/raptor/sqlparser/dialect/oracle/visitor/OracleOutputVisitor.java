...
import studio.raptor.sqlparser.dialect.oracle.ast.stmt.OracleAlterIndexStatement.Rebuild;
...
//    printAlias(x.getAlias());
  ...
  public void endVisit(
      studio.raptor.sqlparser.dialect.oracle.ast.stmt.OracleExceptionStatement.Item x) {
