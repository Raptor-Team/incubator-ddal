...
public class DefaultLocalConfigFetcher extends LocalConfigFetcher {
  ...
  public DefaultLocalConfigFetcher() {
    setServerConfigPath("ddal/server-config.xml");
    setShardConfigPath("ddal/shard-config.xml");
    setRuleConfigPath("ddal/rule-config.xml");
    setRoutingDsPath("ddal/routing-ds.properties");
    setSystemPropPath("ddal/system.properties");
  }
}
