...
*/
  ...
  $.serviceUrl.appCenter = {};
  $.serviceUrl.appCenter.create = '/appcenter/create';
  $.serviceUrl.appCenter.delete = '/appcenter/';
  $.serviceUrl.appCenter.paginationQuery = '/appcenter/list';
  $.serviceUrl.appCenter.list = '/appcenter/list';

  $.serviceUrl.app = {};
  $.serviceUrl.app.create = "";

  $.serviceUrl.gid = {};
  $.serviceUrl.gid.centers = '/gid/centers';
  $.serviceUrl.gid.reset = '/gid/reset/';

  $.serviceUrl.gid.zookeeper = {};
  $.serviceUrl.gid.zookeeper.info = '/gid/zookeeper/info';
  $.serviceUrl.gid.zookeeper.modify = '/gid/zookeeper/modify';

  $.loadingAvg = $("#loading-tpl").html();
...
function timeoutLoading(timeout, before, callback, callbackArgs) {
  before.apply(this);
  setTimeout(function(){
