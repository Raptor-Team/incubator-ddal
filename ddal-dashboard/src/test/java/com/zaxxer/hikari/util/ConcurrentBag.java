...
public class ConcurrentBag<T extends IConcurrentBagEntry> implements AutoCloseable
{
   ...
   //private final Meter borrowMeter;
   ...
   public ConcurrentBag(final IBagStateListener listener)
   {
     ...
     //borrowMeter = metricRegistry.meter("borrowMeter");
     borrowTimer = metricRegistry.timer("borrowTimer");
     reporter = ConsoleReporter.forRegistry(metricRegistry)
         .convertDurationsTo(TimeUnit.NANOSECONDS).build();
   ...
   {
     Context timerContext = borrowTimer.time();
     try {
