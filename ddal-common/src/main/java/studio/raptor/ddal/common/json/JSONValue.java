 ...
 */
package studio.raptor.ddal.common.json;
...
import studio.raptor.ddal.common.json.parser.JSONParser;
import studio.raptor.ddal.common.json.parser.ParseException;
...
public class JSONValue {
	 ...
	 * 
	 * @see studio.raptor.ddal.common.json.parser.JSONParser#parse(Reader)
	 * @see #parseWithException(Reader)
	 * 
	 * @param in
	 * @return Instance of the following:
	 *	studio.raptor.ddal.common.json.JSONObject,
	 * 	studio.raptor.ddal.common.json.JSONArray,
	 * 	java.lang.String,
	 * 	java.lang.Number,
	 * 	java.lang.Boolean,
	 * 	null
	 ...
	 * Parse JSON text into java object from the input source.
	 * 
	 * @see studio.raptor.ddal.common.json.parser.JSONParser
	 * 
	 * @param in
	 * @return Instance of the following:
	 * 	studio.raptor.ddal.common.json.JSONObject,
	 ...
	 * 
	 * @see studio.raptor.ddal.common.json.JSONObject#toJSONString(Map)
	 *
	 * @param value
