 ...
 * @since 3.0.0
 */
public class SqlInsertBuilderImpl extends AbstractSqlBuilder {

  private ThreadLocal<SQLInsertStatement> stmt;
  private String dbType;

  public SqlInsertBuilderImpl(SQLInsertStatement stmt, String dbType) {
