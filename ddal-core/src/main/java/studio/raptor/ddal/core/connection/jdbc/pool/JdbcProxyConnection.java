...
public class JdbcProxyConnection extends ProxyConnection implements Wrapper, Connection, AutoCloseable {
  ...
  JdbcProxyConnection(final PoolEntry poolEntry, final Connection connection,
