...
import static studio.raptor.ddal.core.connection.jdbc.util.ConcurrentBag.IConcurrentBagEntry.STATE_REMOVED;
import static studio.raptor.ddal.core.connection.jdbc.util.ConcurrentBag.IConcurrentBagEntry.STATE_RESERVED;
...
public class ConcurrentBag<T extends IConcurrentBagEntry> implements AutoCloseable {
  ...
  public boolean remove(final T bagEntry) {
    if (!bagEntry.compareAndSet(STATE_IN_USE, STATE_REMOVED) && !bagEntry
        .compareAndSet(STATE_RESERVED, STATE_REMOVED) && !closed) {
  ...
  private boolean useWeakThreadLocals() {
    try {
      if (System.getProperty("studio.raptor.ddal.core.connection.useWeakReferences")
          != null) {   // undocumented manual override of WeakReference behavior
        return Boolean.getBoolean("studio.raptor.ddal.core.connection.useWeakReferences");
      }
