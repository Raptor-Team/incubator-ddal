 ...
 * @since 3.0.0
 */
public class GroupByCoupling extends ProcessNode {

  @Override
  protected void execute(ProcessContext context) {
    context.setMergedResult(
    new GroupByCouplingResultData(context.getMergedResult(), context.getResultDataMergeContext()).couple()
    );
  }
}
